...
class MOSEI(Dataset):
    ...
    def get_seq_len(self):
        return self.text.shape[1], 74, self.vision.shape[1]

    def get_dim(self):
        return self.text.shape[2], 74, self.vision.shape[2]
    ...
    def __getitem__(self, index):
        return (self.text[index], 0, self.vision[index]), 0, self.id[index]
