...
class MoseiEmoTrainer(TrainerBase):
    def __init__(self, args, model, criterion, optimizer, scheduler, device, dataloaders):
        ...
        self.headers = [
            ['phase', 'happy (wacc)', 'sad (wacc)', 'anger (wacc)', 'surprise (wacc)', 'disgust (wacc)', 'fear (wacc)', 'average'],
            ['phase', 'happy (f1)', 'sad (f1)', 'anger (f1)', 'surprise (f1)', 'disgust (f1)', 'fear (f1)', 'average'],
            ['phase', 'happy (auc)', 'sad (auc)', 'anger (auc)', 'surprise (auc)', 'disgust (auc)', 'fear (auc)', 'average'],
